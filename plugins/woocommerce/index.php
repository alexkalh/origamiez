...
if( is_plugin_active( 'woocommerce/woocommerce.php' )){
	...
	function origamiez_woocommerce_enqueue_scripts(){
		...
		wp_enqueue_style(ORIGAMIEZ_PREFIX . 'woocommerce-typography', "{$dir}/plugins/woocommerce/css/typography{$affix}.css", array(), NULL);
		...
		if ('custom' == get_theme_mod('skin', 'default')) {
			...
			wp_enqueue_style(ORIGAMIEZ_PREFIX . 'woocommerce-color', "{$dir}/plugins/woocommerce/css/color{$affix}.css", array(), NULL);
		}
	}
